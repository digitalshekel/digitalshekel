...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Digitalshekel " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"digitalshekeltools.com", "138.197.64.145"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"digitalshekeltools.com", "testnet-seed.digitalshekeltools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Digitalshekel is probably already running."), addrBind.ToString().c_str());
        else
